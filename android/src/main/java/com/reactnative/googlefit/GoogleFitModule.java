...
public class GoogleFitModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
    ...
    public void getSleepSamples(double startDate,
        ...
        try {
            mGoogleFitManager.getSleepHistory().aggregateDataByDate((long) startDate, (long) endDate, successCallback);
        } catch (IllegalViewOperationException e) {
            errorCallback.invoke(e.getMessage());
        }
    }
    ...
    public void getHeartRateSamples(double startDate,
        ...
        try {
            mGoogleFitManager.getHeartrateHistory().aggregateDataByDate((long) startDate, (long) endDate, successCallback);
        } catch (IllegalViewOperationException e) {
            errorCallback.invoke(e.getMessage());
        }
    }
